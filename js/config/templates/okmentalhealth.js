    ...
    content: {
        ...
        chat: {
            samplePromptsByAgent: {
                'ok-grants-data': [
                    { label: 'MH grants', prompt: 'What community mental health grants are open?' },
                    { label: 'Crisis funding', prompt: 'Which grants fund crisis services?' },
                    { label: 'Closing soon', prompt: 'Which behavioral health grants are closing soon?' },
                    { label: 'Nonprofits', prompt: 'What grants can nonprofits apply for?' },
                    { label: 'Catalog size', prompt: 'How many grants are in the catalog?' },
                    { label: 'Clinic sequence', prompt: 'Recommend how a community clinic should sequence behavioral-health funding applications.', skipFastPath: true },
                    { label: 'Crisis vs schools', prompt: 'Compare crisis-unit versus school-based awards and which is a better first step for a rural county.', skipFastPath: true },
                    { label: 'Officer questions', prompt: 'What should a nonprofit ask a program officer before applying?', skipFastPath: true },
                    { label: 'Over capacity', prompt: 'If our SUD program is over capacity, which funding strategy makes sense?', skipFastPath: true },
                    { label: 'Two-proposal cap', prompt: 'Explain how to prioritize applications when staff can only write two proposals.', skipFastPath: true },
                ],
                'ok-fraud': [
                    { label: 'YTD loss', prompt: 'What is the total fraud detected YTD?' },
                    { label: 'Flagged claims', prompt: 'How many claims are flagged?' },
                    { label: 'High-risk', prompt: 'How many high-risk claims are there?' },
                    { label: 'By flag type', prompt: 'Break down fraud loss by flag type' },
                    { label: 'Crisis stats', prompt: 'What are the crisis call center stats?' },
                    { label: 'Relapse', prompt: 'What is the statewide relapse rate?' },
                    { label: 'Work first', prompt: 'Which fraud patterns should investigators work first this week, and why?', skipFastPath: true },
                    { label: 'Recoverable loss', prompt: 'Compare phantom billing versus upcoding and where loss is most recoverable.', skipFastPath: true },
                    { label: 'Staffing plan', prompt: 'Recommend a staffing plan if complex Medicaid cases keep rising.', skipFastPath: true },
                    { label: 'Leadership brief', prompt: 'How should wait times and fraud exposure be presented together to leadership?', skipFastPath: true },
                    { label: 'Treatment contracts', prompt: 'What follow-up should we ask about outcomes before changing treatment contracts?', skipFastPath: true },
                    { label: 'Triage overloaded', prompt: 'If investigators are overloaded, how would you triage the caseload?', skipFastPath: true },
                ],
            },
        },
        crisisLanding: {
