/**
 * BoosterEngagementPanel — donor engagement tab content for Texas College staff portal.
 */
...
export default function BoosterEngagementPanel({ onDonorClick }) {
    ...
    const donorDashboards = dashboards.filter((d) => !d.section || d.section === 'donors');
